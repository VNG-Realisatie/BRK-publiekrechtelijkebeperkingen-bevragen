...
class PubliekrechtelijkeBeperkingenApi(object):
    ...
    def get_publiekrechtelijke_beperkingen(self, kadastraal_onroerende_zaak_identificatie, **kwargs):  # noqa: E501
        ...
        :param CategorieEnum grondslag_categorie: Een categorie van grondslaghen (aardaantekeningen). Bijvoorbeeld om op alle privaatrechtelijkebeperkingen met een grondslag die iets met monumenten te maken heeft (16 grondslagen) te kunnen selecteren. (Zie ./features/grondslagCategorie.feature 
        :param bool inclusief_beeindigde_beperkingen: Indien true dan worden ook beperkingen met een datumBeeindiging in het verleden meegeleverd. 
    ...
    def get_publiekrechtelijke_beperkingen_with_http_info(self, kadastraal_onroerende_zaak_identificatie, **kwargs):  # noqa: E501
        ...
        all_params = [
            ...
            'fields',
            'grondslag_categorie',
            'inclusief_beeindigde_beperkingen'
        ]
        all_params.extend(
            [
                'async_req',
        ...
        if 'grondslag_categorie' in local_var_params and local_var_params['grondslag_categorie'] is not None:  # noqa: E501
            query_params.append(('grondslagCategorie', local_var_params['grondslag_categorie']))  # noqa: E501
        if 'inclusief_beeindigde_beperkingen' in local_var_params and local_var_params['inclusief_beeindigde_beperkingen'] is not None:  # noqa: E501
            query_params.append(('inclusiefBeeindigdeBeperkingen', local_var_params['inclusief_beeindigde_beperkingen']))  # noqa: E501
