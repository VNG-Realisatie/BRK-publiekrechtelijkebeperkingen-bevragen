...
class PubliekrechtelijkeBeperkingHal(object):
    ...
    openapi_types = {
        ...
        'beperkingsgebied': 'Beperkingsgebied',
    ...
    def __init__(self, identificatie=None, domein=None, grondslag=None, datum_in_werking=None, datum_beeindiging=None, bevoegd_gezag=None, stuk_identificaties=None, is_gebaseerd_op_stukdeel_identificatie=None, is_vermeld_in_stukdeel_identificaties=None, beperkingsgebied=None, links=None, local_vars_configuration=None):  # noqa: E501
        ...
        if beperkingsgebied is not None:
            self.beperkingsgebied = beperkingsgebied
    ...
    def stuk_identificaties(self):
        """Gets the stuk_identificaties of this PubliekrechtelijkeBeperkingHal.  # noqa: E501
        ...
        :return: The stuk_identificaties of this PubliekrechtelijkeBeperkingHal.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def stuk_identificaties(self, stuk_identificaties):
        """Sets the stuk_identificaties of this PubliekrechtelijkeBeperkingHal.

        Identificatie van het stuk. Een stuk is een brondocument dat aanleiding geeft tot een wijziging van de gegevens in een basisregistratie. Dit kan een aangeboden stuk of een kadasterstuk zijn.   # noqa: E501

        :param stuk_identificaties: The stuk_identificaties of this PubliekrechtelijkeBeperkingHal.  # noqa: E501
        :type: list[str]
        """
    ...
    @property
    def beperkingsgebied(self):
        """Gets the beperkingsgebied of this PubliekrechtelijkeBeperkingHal.  # noqa: E501


        :return: The beperkingsgebied of this PubliekrechtelijkeBeperkingHal.  # noqa: E501
        :rtype: Beperkingsgebied
        """
        return self._beperkingsgebied

    @beperkingsgebied.setter
    def beperkingsgebied(self, beperkingsgebied):
        """Sets the beperkingsgebied of this PubliekrechtelijkeBeperkingHal.


        :param beperkingsgebied: The beperkingsgebied of this PubliekrechtelijkeBeperkingHal.  # noqa: E501
        :type: Beperkingsgebied
        """

        self._beperkingsgebied = beperkingsgebied
